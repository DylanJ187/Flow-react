  ...
  const columns = [
    {
      ...
      valueOptions: [
        ...
        "English",
        "Japanese",
      ] /* change this to a variable and make it dynamic so like at the start have a survey to create 
    const subjectSelection = [subject 1,... subject 6]
    then just have valueOptions: {subjectSelection}
  */,
    },
    {
      field: "description",
  ...
  return (
    <Box
      ...
      sx={{
        ...
        "& .MuiDataGrid-cell--editing": {
          backgroundColor: `${colors.sunglasses[200]} !important`,
        },
    ...
    >
      ...
      <DataGrid
        ...
        sx={{ backgroundColor: `${colors.sunglasses[200]} !important` }}
