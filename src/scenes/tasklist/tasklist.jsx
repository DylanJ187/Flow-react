...
const Tasklist = () => {
  ...
  {
    /*const subjectArray = useSelector((state) => state.subjects); */
  }

  //subjectArray is a thing in profile.jsx we just need to save the value from profile.jsx and import it here, see above I've used redux to handle the state of subjectArray but it doesn't save at all cus it hasn't been implemented on the server side
